...
+ (NSDate *) dateTomorrowAfterTomorrow
{
...
- (NSDate *) dateByAddingMonths:(NSInteger)months
{
    ...
    NSInteger newMonth =  months + (NSInteger)components.month;
    if (abs(newMonth/12))
        components.year += newMonth/12;
    
    components.month = newMonth%12;
...
- (NSInteger)totalMonthWithDate:(NSDate *)date{
