...
@interface MyCommitVC ()<UITableViewDelegate,UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (strong, nonatomic)  NSMutableArray *arrData;//图片名数组

@end

@implementation MyCommitVC

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view from its nib.
    self.navigationItem.title = @"我的评论";
    [self.tableView registerNib:[UINib nibWithNibName:@"MyCommitTableViewCell" bundle:nil] forCellReuseIdentifier:@"MyCommitTableViewCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *identifier = @"MyCommitTableViewCell";
    MyCommitTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
