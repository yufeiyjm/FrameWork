...
#import "AddSkillVC.h"
#import "SkillListTableViewCell.h"
@interface SkillListVC ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"SkillListTableViewCell" bundle:nil] forCellReuseIdentifier:@"SkillListTableViewCell"];
    ...
    [addBtn setTitle:@"添加技能" forState:UIControlStateNormal];
...
-(void)addBtnClick{
    AddSkillVC *vc = [[AddSkillVC alloc]init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *identifier = @"SkillListTableViewCell";
    SkillListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
