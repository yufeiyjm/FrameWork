...
@interface BaseInformationViewController ()<UIActionSheetDelegate,UINavigationControllerDelegate, UIImagePickerControllerDelegate>
@property (weak, nonatomic) IBOutlet UIImageView *headButton;
...
- (void)viewDidLoad {
    ...
    [self.sexButton setImage:IMAGE(@"男") forState:UIControlStateNormal];
    [self.sexButton setImage:IMAGE(@"女") forState:UIControlStateSelected];
