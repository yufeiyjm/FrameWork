...
#import "InterviewNOListTableViewCell.h"

@interface InterviewNOListVC ()<UITableViewDelegate,UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (strong, nonatomic)  NSMutableArray *arrData;//图片名数组

@end

@implementation InterviewNOListVC

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view from its nib.
    self.navigationItem.title = @"已面试";
    [self.tableView registerNib:[UINib nibWithNibName:@"InterviewNOListTableViewCell" bundle:nil] forCellReuseIdentifier:@"InterviewNOListTableViewCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *identifier = @"InterviewNOListTableViewCell";
    InterviewNOListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
