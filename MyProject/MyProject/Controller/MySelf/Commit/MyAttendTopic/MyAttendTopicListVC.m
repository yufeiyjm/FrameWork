...
#import "MyAttendTopicListTableViewCell.h"

@interface MyAttendTopicListVC ()<UITableViewDelegate,UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (strong, nonatomic)  NSMutableArray *arrData;//图片名数组

@end

@implementation MyAttendTopicListVC

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view from its nib.
    self.navigationItem.title = @"我参与的话题";
    [self.tableView registerNib:[UINib nibWithNibName:@"MyAttendTopicListTableViewCell" bundle:nil] forCellReuseIdentifier:@"MyAttendTopicListTableViewCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *identifier = @"MyAttendTopicListTableViewCell";
    MyAttendTopicListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
