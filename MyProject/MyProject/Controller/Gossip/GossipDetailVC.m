...
@interface GossipDetailVC ()<MHFacebookImageViewerDatasource>
...
-(void)setImageArr:(NSArray *)imageArr{
    ...
    self.topView.frame = CGRectMake(0, 0, kScreenWidth, self.contentLabel.frame.size.height + self.contentLabel.frame.origin.y + self.imageBackTop.constant + self.imageBackHeight.constant  + 20 + 27);
