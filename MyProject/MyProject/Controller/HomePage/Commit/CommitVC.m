...
@interface CommitVC ()<UITableViewDelegate,UITableViewDataSource>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *identifier = @"CommitTableViewCell";
    CommitTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
